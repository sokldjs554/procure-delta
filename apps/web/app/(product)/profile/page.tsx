...
function listValues(profile: Profile): Record<Lists, string> {
...
export default function ProfilePage() {
  ...
  async function save(event: FormEvent) {
    ...
    try {
      ...
      setProfile(saved);
      setRaw(listValues(saved));
      setMessage("프로필을 저장했습니다. 다음 공고 조회부터 반영됩니다.");
    } catch (error) {
