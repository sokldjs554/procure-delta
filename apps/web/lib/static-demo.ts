...
const evaluation: EvaluationSummary = {
  ...
  hosted_optimization: {
    ...
    gated_calls: null,
    avoided_calls: null,
    call_reduction_rate: null,
    all_tokens: null,
    gated_tokens: null,
    token_reduction_rate: null,
    reported_cost_reduction_rate: null,
    cost_basis: null,
    notice: "실제 hosted LLM 경로는 실행하지 않았습니다.",
  },
  provider_contract_optimization: {
    status: "measured",
    all_calls: 10,
    gated_calls: 5,
    avoided_calls: 5,
    ...
    cost_basis: null,
    notice:
      "HTTP provider stub 계약 측정입니다. 외부 모델 품질·실제 토큰·과금은 측정하지 않았습니다.",
  },
  routes: {
    deterministic: {
      status: "measured",
    ...
    provider_contract_all: {
      ...
      schema_failures: 4,
      grounded_acceptance_rate: 0.5,
      p50_latency_ms: 1.9718629999943005,
      p95_latency_ms: 3.3097369999950397,
      hosted_calls: 10,
      prompt_tokens: 1000,
      ...
      language: null,
      notice:
        "MockTransport HTTP 계약 측정 · 외부 모델 품질과 실제 과금은 측정하지 않음",
    },
    provider_contract_gated: {
      ...
      schema_failures: 4,
      grounded_acceptance_rate: 0.5,
      p50_latency_ms: 1.272859500005552,
      p95_latency_ms: 2.1316749499888488,
      hosted_calls: 5,
      prompt_tokens: 500,
      ...
      language: null,
      notice:
        "deterministic validation 후 provider stub 호출 · 외부 모델 품질은 측정하지 않음",
    },
    hosted_all: {
      status: "not_run",
      support: 0,
